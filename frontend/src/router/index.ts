...
const routes: RouteRecordRaw[] = [
  ...
  { path: '/blind-tastings', name: 'blindList', component: () => import('@/pages/BlindTasting.vue'), meta: { title: '杯测盲评', requiresAuth: true } },
  { path: '/blind-tastings/:id', name: 'blindDetail', component: () => import('@/pages/BlindTasting.vue'), meta: { title: '盲评详情', requiresAuth: true } },
